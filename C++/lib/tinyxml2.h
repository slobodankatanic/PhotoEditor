...
#define XMLCheckResult(a_eResult) if (a_eResult != tinyxml2::XML_SUCCESS) { std::cout << "Error: " << a_eResult; throw FileFormatException(); } 
#define XMLCheckSaveResult(a_eResult) if (a_eResult != tinyxml2::XML_SUCCESS) { std::cout << "Error: " << a_eResult; throw FileOrDirectoryNameException(); } 
